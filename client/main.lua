...
Citizen.CreateThread(function()
	...
	-- open tattoo
	exports['qb-target']:AddBoxZone("Tattoo-Shop-1", vector3(-1153.04, -1427.57, 4.95), 1, 1, {
		name = "Tattoo Shop",
		heading = 0,
		debugPoly = false,
		minZ=3.95,
		maxZ=5.95
			...
			options = {
				{  
					event = "rsg_tattoos:client:openshop",
					icon = "fas fa-heart",
					label = "Shop for Tattoos",
				},
				{  
					event = "rsg_tattoos:client:getnaked",
					icon = "fas fa-heart",
					label = "Undress",
				},
				{  
	...
	-- open tattoo
	exports['qb-target']:AddBoxZone("Tattoo-Shop-2", vector3(1323.97, -1653.78, 52.28), 1, 1, {
		name = "Tattoo Shop",
		heading = 0,
		debugPoly = false,
		minZ=51.28,
	...
	-- open tattoo
	exports['qb-target']:AddBoxZone("Tattoo-Shop-3", vector3(323.29, 182.41, 103.59), 1, 1, {
		name = "Tattoo Shop",
		heading = 35,
		debugPoly = false,
		minZ=102.59,
	...
	-- open tattoo
	exports['qb-target']:AddBoxZone("Tattoo-Shop-4", vector3(-3171.66, 1076.18, 20.83), 1, 1, {
		name = "Tattoo Shop",
		heading = 35,
		debugPoly = false,
		minZ=19.83,
	...
	-- open tattoo
	exports['qb-target']:AddBoxZone("Tattoo-Shop-5", vector3(1863.1, 3746.83, 33.03), 1, 1, {
		name = "Tattoo Shop",
		heading = 335,
		debugPoly = false,
		minZ=32.03,
	...
	-- open tattoo
	exports['qb-target']:AddBoxZone("Tattoo-Shop-6", vector3(-293.06, 6201.18, 31.49), 1, 1, {
		name = "Tattoo Shop",
		heading = 345,
		debugPoly = false,
		minZ=30.49,
...
Citizen.CreateThread(function()
    AddTextEntry("VRP Tattoos", "Tattoo Shop")
    for k, v in pairs(Config.Shops) do
        ...
        BeginTextCommandSetBlipName("VRP Tattoos")
...
RegisterNetEvent('rsg_tattoos:client:openshop')
AddEventHandler('rsg_tattoos:client:openshop', function()
	OpenTattooShop()
end)

RegisterNetEvent('rsg_tattoos:client:getnaked')
AddEventHandler('rsg_tattoos:client:getnaked', function()
	GetNaked()
end)

RegisterNetEvent('rsg_tattoos:client:removetats')
AddEventHandler('rsg_tattoos:client:removetats', function()
